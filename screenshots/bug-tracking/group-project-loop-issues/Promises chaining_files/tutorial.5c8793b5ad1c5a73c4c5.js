...
var f, d, h, p = t.classList.contains("language-javascript"), m = t.classList.contains("language-markup"), g = +e.getAttribute("data-trusted");
!+e.getAttribute("data-no-strict") && p && (s = "'use strict';\n" + s);
var y = !0;
if (p || m) {
...
} else e.hasAttribute("data-refresh") && f && (f.remove(), f = null), f ? E() : ((f = document.createElement("iframe")).className = "js-frame", 
...
p ? w() : function() {
var t;
if (h && e.hasAttribute("data-refresh") && (h.remove(), h = null), h || (h = e.querySelector(".code-result")), 
h) t = h.querySelector("iframe"); else {
...
"0" === e.getAttribute("data-demo-height")) h.style.display = "none"; else if (e.hasAttribute("data-demo-height")) {
...
y && e.hasAttribute("data-autorun") || o(h) || h.scrollIntoView(!1);
} else {
...
a.submit(), a.remove(), y && e.hasAttribute("data-autorun") || (t.onload = function() {
e.hasAttribute("data-demo-height") || r.iframe(t), o(h) || h.scrollIntoView(!1);
});
}
}(), y = !1;
}
...
toolbar: {
lang_switcher: {
cta_text: '<p>We want to make this open-source project available for people all around the world.</p> <p><a href="https://github.com/javascript-tutorial/translate" rel="noopener noreferrer" target="_blank">Help us to translate</a> the content of this tutorial to your language!</p>\n',
...
function h(e) {
window.notificationManager || (window.notificationManager = new d(e));
}
var p = function() {
function e(t, n, r) {
l(this, e);
...
e.exports = function(e, t, n) {
var c, u, f, d, h, p, m = 0, g = !1, y = !1, v = !0;
if ("function" != typeof e) throw new TypeError(a);
function b(t) {
var n = c, r = u;
return c = u = void 0, m = t, d = e.apply(r, n);
}
function E(e) {
var n = e - p;
return void 0 === p || n >= t || n < 0 || y && e - m >= f;
}
function w() {
var e = o();
if (E(e)) return _(e);
...
return m = e, h = setTimeout(w, t), g ? b(e) : d;
}(p);
if (y) return h = setTimeout(w, t), b(p);
}
return void 0 === h && (h = setTimeout(w, t)), d;
}
return t = i(t) || 0, r(n) && (g = !!n.leading, f = (y = "maxWait" in n) ? s(i(n.maxWait) || 0, t) : f, 
v = "trailing" in n ? !!n.trailing : v), S.cancel = function() {
void 0 !== h && clearTimeout(h), m = 0, c = p = u = h = void 0;
}, S.flush = function() {
...
var o = {};
for (var i in t[r.util.objId(e)] = o, e) e.hasOwnProperty(i) && (o[i] = r.util.clone(e[i], t));
return o;

case "Array":
if (t[r.util.objId(e)]) return t[r.util.objId(e)];
o = [];
return t[r.util.objId(e)] = o, e.forEach(function(e, n) {
...
for (var a in n = arguments[1]) n.hasOwnProperty(a) && (i[a] = n[a]);
return i;
}
var s = {};
...
for (var i in o = o || {}, e) e.hasOwnProperty(i) && (t.call(e, i, e[i], n || i), 
"Object" !== r.util.type(e[i]) || o[r.util.objId(e[i])] ? "Array" !== r.util.type(e[i]) || o[r.util.objId(e[i])] || (o[r.util.objId(e[i])] = !0, 
r.languages.DFS(e[i], t, i, o)) : (o[r.util.objId(e[i])] = !0, r.languages.DFS(e[i], t, null, o)));
}
},
plugins: {},
...
t.parentNode && (l = t.parentNode, /pre/i.test(l.nodeName) && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + a));
var c = {
element: t,
language: a,
grammar: s,
...
i && i.call(c.element), r.hooks.run("after-highlight", c), r.hooks.run("complete", c);
...
c.element.innerHTML = c.highlightedCode, i && i.call(t), r.hooks.run("after-highlight", c), 
...
matchGrammar: function(e, t, n, o, i, a, s) {
var l = r.Token;
...
var d = u[f], h = d.inside, p = !!d.lookbehind, m = !!d.greedy, g = 0, y = d.alias;
if (m && !d.pattern.global) {
var v = d.pattern.toString().match(/[imuy]*$/)[0];
d.pattern = RegExp(d.pattern.source, v + "g");
}
d = d.pattern || d;
for (var b = o, E = i; b < t.length; E += t[b].length, ++b) {
var w = t[b];
if (t.length > e.length) return;
if (!(w instanceof l)) {
if (m && b != t.length - 1) {
if (d.lastIndex = E, !(L = d.exec(e))) break;
for (var _ = L.index + (p ? L[1].length : 0), S = L.index + L[0].length, T = b, k = E, A = t.length; T < A && (k < S || !t[T].type && !t[T - 1].greedy); ++T) _ >= (k += t[T].length) && (++b, 
E = k);
if (t[b] instanceof l) continue;
O = T - b, w = e.slice(E, k), L.index -= E;
} else {
d.lastIndex = 0;
var L = d.exec(w), O = 1;
}
...
S = (_ = L.index + g) + (L = L[0].slice(g)).length;
var C = w.slice(0, _), I = w.slice(S), x = [ b, O ];
C && (++b, E += C.length, x.push(C));
var N = new l(c, h ? r.tokenize(L, h) : L, y, L, m);
if (x.push(N), I && x.push(I), Array.prototype.splice.apply(t, x), 1 != O && r.matchGrammar(e, t, n, b, E, !0, c), 
a) break;
} else if (a) break;
}
}
...
}, Prism.languages.insertBefore("http", "header-name", o);
}
},
7: function(e, t, n) {
"use strict";
...
function h(e, t, n) {
if (null !== e) if (d && e.forEach === d) e.forEach(t, n); else if (e.length === +e.length) for (var r = 0, o = e.length; r < o; r += 1) t.call(n, e[r], r, e); else for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && t.call(n, e[i], i, e);
}
var p = /%[sdj%]/g;
function m(e) {
...
e && "object" === r(e) ? h(y(e), function(e, r) {
t[n + "." + r] = e;
}) : t[n] = e;
}), t;
}
...
if (!(f(n) || l(n) || c(n) || 0 === o && u(n))) throw new TypeError("Invalid translation - [String|Object|Array|Number|Boolean] expected.");
this._storage[b(e, t)] = {
translation: n,
locale: e,
raw: !0
...
i.push("params = flatten(params);"), h(r, function(e) {
if ("literal" !== e.type) {
...
count: n,
value: n
}), r.compiled.call(this, n, y, w))) : e + ": No translation for [" + t + "]";
...
var t = this;
return s(e) && (e = JSON.parse(e)), h(e.locales, function(e, n) {
h(e, function(e, r) {
t.addPhrase(n, r, e, 0);
});
...
function ue() {
var e, t;
for (e = [], (t = ye()) === o && (t = fe()) === o && (t = pe()); t !== o; ) e.push(t), 
(t = ye()) === o && (t = fe()) === o && (t = pe());
return e;
}
function fe() {
...
n !== o && (r = function e() {
var n, r, i, a;
return n = Q, (r = de()) !== o ? (124 === t.charCodeAt(Q) ? (i = p, Q++) : (i = o, 
0 === ie && le(m)), i !== o && (a = e()) !== o ? (ee = n, r = g(r, a), n = r) : (Q = n, 
n = s)) : (Q = n, n = s), n === o && (n = Q, (r = de()) !== o && (ee = n, r = y(r)), 
n = r), n;
}()) !== o ? (t.substr(Q, 2) === u ? (i = u, Q += 2) : (i = o, 0 === ie && le(f)), 
i !== o ? ((a = function() {
var e, n, r;
return e = Q, 58 === t.charCodeAt(Q) ? (n = R, Q++) : (n = o, 0 === ie && le(P)), 
n !== o && (r = me()) !== o ? (ee = e, n = j(r), e = n) : (Q = e, e = s), e;
}()) === o && (a = d), a !== o ? (ee = e, e = n = h(r, a)) : (Q = e, e = s)) : (Q = e, 
e = s)) : (Q = e, e = s), e;
}
function de() {
var e, n, r, i, a, l;
if (e = Q, 61 === t.charCodeAt(Q) ? (n = v, Q++) : (n = o, 0 === ie && le(b)), n !== o) {
...
i === o && (i = d), i !== o) {
if (a = [], (l = he()) !== o) for (;l !== o; ) a.push(l), l = he(); else a = s;
...
function he() {
var e, n, r;
return e = Q, 92 === t.charCodeAt(Q) ? (n = A, Q++) : (n = o, 0 === ie && le(L)), 
n !== o ? (O.test(t.charAt(Q)) ? (r = t.charAt(Q), Q++) : (r = o, 0 === ie && le(C)), 
r !== o ? (ee = e, e = n = I(r)) : (Q = e, e = s)) : (Q = e, e = s), e === o && (e = Q, 
n = Q, ie++, 124 === t.charCodeAt(Q) ? (r = p, Q++) : (r = o, 0 === ie && le(m)), 
r === o && (t.substr(Q, 2) === u ? (r = u, Q += 2) : (r = o, 0 === ie && le(f))), 
ie--, r === o ? n = x : (Q = n, n = s), n !== o ? (t.length > Q ? (r = t.charAt(Q), 
Q++) : (r = o, 0 === ie && le(N)), r !== o ? (ee = e, e = n = F()) : (Q = e, e = s)) : (Q = e, 
e = s)), e;
}
function pe() {
var e, n, r, i;
...
r !== o ? (ee = e, e = G()) : (Q = e, e = s);
} else Q = e, e = s; else Q = e, e = s;
return e === o && (e = ge()), e;
}
function ge() {
var e, n, r, i;
if (e = Q, X.test(t.charAt(Q)) ? (n = t.charAt(Q), Q++) : (n = o, 0 === ie && le(z)), 
n !== o) {
for (r = [], $.test(t.charAt(Q)) ? (i = t.charAt(Q), Q++) : (i = o, 0 === ie && le(Y)); i !== o; ) r.push(i), 
$.test(t.charAt(Q)) ? (i = t.charAt(Q), Q++) : (i = o, 0 === ie && le(Y));
r !== o ? (ee = e, e = n = F()) : (Q = e, e = s);
} else Q = e, e = s;
return e;
}
function ye() {
var e, t, n, r, i;
if (e = Q, t = [], n = Q, r = Q, ie++, (i = fe()) === o && (i = pe()), ie--, i === o ? r = x : (Q = r, 
r = s), r !== o && (i = ve()) !== o ? (ee = n, n = r = K(i)) : (Q = n, n = s), n !== o) for (;n !== o; ) t.push(n), 
n = Q, r = Q, ie++, (i = fe()) === o && (i = pe()), ie--, i === o ? r = x : (Q = r, 
r = s), r !== o && (i = ve()) !== o ? (ee = n, n = r = K(i)) : (Q = n, n = s); else t = s;
return t !== o && (ee = e, t = V(t)), e = t;
}
function ve() {
var e, n, r;
return e = Q, 92 === t.charCodeAt(Q) ? (n = A, Q++) : (n = o, 0 === ie && le(L)), 
n !== o ? (J.test(t.charAt(Q)) ? (r = t.charAt(Q), Q++) : (r = o, 0 === ie && le(Z)), 
r !== o ? (ee = e, e = n = I(r)) : (Q = e, e = s)) : (Q = e, e = s), e === o && (t.length > Q ? (e = t.charAt(Q), 
Q++) : (e = o, 0 === ie && le(N))), e;
}
